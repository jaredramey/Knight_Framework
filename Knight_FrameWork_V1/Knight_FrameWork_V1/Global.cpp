...
GLuint Global::CreateShader(GLenum a_eShaderType, const char *a_strShaderFile)
{
...
GLuint Global::CreateProgram(const char *a_vertex, const char *a_frag)
{
...
float* Global::getOrtho(float left, float right, float bottom, float top, float a_fNear, float a_fFar)
{
